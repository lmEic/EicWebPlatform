...
namespace Lm.Eic.App.DomainModel.Bpm.Purchase
{
    ...
    /// </summary>
    [Serializable]
    public partial class SupplierQualifiedCertificateModel
    {
        public SupplierQualifiedCertificateModel()
        { }
        #region Model
        ...
        private int _eligiblecertificateindex;
        /// <summary>
        ///证书序列号
        /// </summary>
        public int EligibleCertificateIndex
        {
            set { _eligiblecertificateindex = value; }
            get { return _eligiblecertificateindex; }
        }
    ...
    public class SuppliersSumInfoVM
    {
        ...
        ///上次采购时间
        /// </summary>
        public DateTime UpperPurchaseDate { get; set; }
        /// <summary>
        ///最近采购时间
        /// </summary>
        public DateTime LastPurchaseDate { get; set; }
        ...
        ///供应商负责人
        /// </summary>
        public string SupplierPrincipal { get; set; }
        /// <summary>
        ///付款方式
        /// </summary>
