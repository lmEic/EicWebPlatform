...
angular.module('bpm.itilApp', ['eicomm.directive', 'mp.configApp', 'ngAnimate', 'ui.router', 'ngMessages', 'cgBusy', 'ngSanitize', 'mgcrea.ngStrap'])
...
.controller('moduleNavCtrl', function ($scope, navDataService, $state) {
    ...
    $scope.promise = navDataService.getSubModuleNavs('ITIL', 'ITILManage').then(function (datas) {
