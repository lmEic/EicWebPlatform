...
namespace Lm.Eic.App.Business.Attendance
{
    public	class AttendanceMachineDll
	{
        ...
        /// <param name="lpszIPAddress"></param>
        /// <param name="dwPortNumber"></param>
        /// <param name="dwPassWord"></param>
        /// <returns></returns>
...
//        Public Declare Function GetSystemDefaultLangID Lib "kernel32" () As Short
        ...
        public static bool MakeXMLRequestHeader(ref string strXML, string strRequest)
        {
            int machineNumber = 1;
            bool ret;
            ret = AttendanceMachineDll.XML_AddString(ref strXML, "REQUEST", strRequest);
            ret = AttendanceMachineDll.XML_AddString(ref strXML, "MSGTYPE", "request") && ret;
            ret = AttendanceMachineDll.XML_AddInt(ref strXML, "MachineID", machineNumber) && ret;
            return ret;
        }
