...
namespace Lm.Eic.App.HwCollaboration.DbAccess
{
    ...
    public class HwDatasTransferDb
    {
        ...
        private OpResult Insert(HwCollaborationDataTransferModel entity)
        {
            ...
            sqlSb.Append("Insert into HwCollaboration_DataTransfer(OpModule, OpContent, OpDate, OpTime, OpPerson, OpSign)")
                 .AppendFormat("values('{0}','{1}','{2}','{3}','{4}','{5}')", entity.OpModule, entity.OpContent, entity.OpDate, entity.OpTime, entity.OpPerson, entity.OpSign);
